...
const Legali18n = {
  fr: {
    pageHeadTitle: 'Mentions légales',
    ...
    editor: {
      ...
      message: (
        <>
          ...
          est situé au <br /> 21 rue Jasmin, 75016 Paris <br /> Président de
          l'association : Stéphane Jander
        </>
      ),
    },
    host: {
  ...
  en: {
    pageHeadTitle: 'Legal notice',
    pageTitle: 'Legal notice',
    editor: {
      title: 'Editor',
      message: (
        <>
          Vélo Longchamp is a not-for-profit organisation (governed by the
          french law of 1 July 1901) based at
          <br />
          21 rue Jasmin, 75016 Paris FRANCE <br />
          Current president of the association: Stéphane Jander
        </>
      ),
    },
    host: {
